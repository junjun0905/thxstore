- ![logo](https://user-images.githubusercontent.com/70404643/119038416-0dcfa880-b9ee-11eb-934d-0e1f29a4b54a.png)
  ...
  (2021/06/20 삼성SW아카데미 제공 서버가 닫힙니다. 서버 이전을 준비 중 입니다.)
  
소셜로그인 시 소셜 회원가입이 필요합니다.

그리고 사장님,사용자 회원가입과 사업자등록증을 통한 사장님의 스토어 등록 절차가 필요합니다.

아래 링크를 통해 프로젝트의 작동 플로우를 빠르게 확인하시는 것을 추천드립니다!
 ## 😎 [프로젝트 작동 플로우 보러가기](https://youtu.be/zS6m7XjCbEo)
